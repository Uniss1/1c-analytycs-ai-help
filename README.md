...
├── query_templates.py # Шаблоны частых запросов
├── query_generator.py # Генерация запросов через LLM (stub)
...
| 1 | Data flow (metadata, templates, validation, formatting) | In progress |
